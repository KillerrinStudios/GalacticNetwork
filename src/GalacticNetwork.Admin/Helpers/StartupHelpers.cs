...
using GalacticNetwork.Admin.ExceptionHandling;
using GalacticNetwork.Admin.Middlewares;
using GalacticNetwork.Admin.Configuration;
using GalacticNetwork.Admin.Configuration.ApplicationParts;
using GalacticNetwork.Admin.Configuration.Constants;
using GalacticNetwork.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using GalacticNetwork.Admin.Helpers.Localization;

namespace GalacticNetwork.Admin.Helpers
{

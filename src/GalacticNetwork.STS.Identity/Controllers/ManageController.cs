...
using GalacticNetwork.STS.Identity.Helpers;
using GalacticNetwork.STS.Identity.Helpers.Localization;
using GalacticNetwork.STS.Identity.ViewModels.Manage;

namespace GalacticNetwork.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("GalacticNetwork.STS.Identity"),

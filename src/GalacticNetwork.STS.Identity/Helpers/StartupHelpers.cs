...
using GalacticNetwork.STS.Identity.Configuration.ApplicationParts;
using GalacticNetwork.STS.Identity.Configuration.Constants;
using GalacticNetwork.STS.Identity.Configuration.Intefaces;
using GalacticNetwork.STS.Identity.Helpers.Localization;
using GalacticNetwork.STS.Identity.Services;
using ILogger = Microsoft.Extensions.Logging.ILogger;

namespace GalacticNetwork.STS.Identity.Helpers
{
